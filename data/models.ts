export type ForgeModel = {
  id: string;
  name: string;
  slug: string;          // slug kebab-case (coincide con carpeta del bucket)
  thumbnail: string;     // /images/models/<slug>.jpg
  stlPath: string;       // clave base para el API (slug o slug/forge-output.stl)
  description: string;
  tips?: string[];
};
...
export const MODELS: ForgeModel[] = [
  ...
  {
    id: "phone-dock",
    name: "Dock para Móvil (USB-C)",
    slug: "phone-dock",
    thumbnail: "/images/models/phone-dock.jpg",
    stlPath: "phone-dock",
    description: "Base con guía USB-C.",
    tips: ["Ten en cuenta la funda", "Ángulo 60-65 recomendado"],
  },
  {
    id: "tablet-stand",
    ...
    description: "Soporte plegable dos ángulos.",
  ...
  },
  {
    ...
    stlPath: "ssd-holder",
    description: "Adaptador SSD a bahía 3.5.",
  ...
  },
  {
    ...
    tips: ["No tapar entradas de aire", "PETG recomendado"],
  },
  {
    id: "mic-arm-clip",
    name: "Clip Brazo Mic",
  ...
  },
  {
    ...
    tips: ["Mide el ancho del hub", "Cinta 3M o tornillos"],
  },
];
