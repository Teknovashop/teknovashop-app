  ...
  const onGenerate = async () => {
    ...
    const payload =
      kind === "cable_tray"
        ...
        : // placeholders (mismo payload temporal hasta que backend soporte VESA/Router)
          {
            model: "cable_tray" as const,
            width_mm: width,
            height_mm: height,
...
function Range({
  ...
  return (
    <label style={{ display: "grid", gridTemplateColumns: "110px 1fr 60px", gap: 8, alignItems: "center" }}>
      <span>{label}</span>
