...
export default function STLViewer({ url, height = 520, background = "#ffffff" }: Props) {
  ...
  useEffect(() => {
    ...
    // CORS ok con Supabase: no tocar crossOrigin
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{ position: "absolute", left: 12, top: 12, fontSize: 12, color: "#111",
